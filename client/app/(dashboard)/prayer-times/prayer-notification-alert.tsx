...
import { fetchMonthlyPrayerTimes, fetchPrayerTimes, fetchWeeklyPrayerTimes } from "@/lib/apis/prayer";
                        ...
                        <div key={prayer} className="bg-muted rounded-lg p-4 text-center">
                          ...
                          <div className="mt-2">
                            <Switch
                              ...
                              disabled
                              id={`notify-${prayer}`}
                              checked={user?.notification_preferences?.prayer_time_notification}
                            />
