...
import { ArrowLeft, Video, Settings, Mic, MicOff, VideoIcon, VideoOff } from "lucide-react";
import {
...
import { StreamFormData, streamSchema } from "@/validation/stream.validation";
...
export default function CreateLiveStreamPage() {
    ...
    const onSubmit = (data: StreamFormData) => {
        mutate({
            ...
            save_recording: data?.save_recording,
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Switch
                                                id="saveRecording"
                                                checked={watch('save_recording')}
                                                onCheckedChange={(checked) => form.setValue('save_recording', checked)}
                                            />
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <div className="space-y-0.5">
                                            ...
                                            <Switch
                                                id="notifyFollowers"
                                                checked={watch('notify_followers')}
                                                onCheckedChange={(checked) => form.setValue('notify_followers', checked)}
                                            />
                                        </div>
                                    </div>
                                </div>
