...
import { endLive } from "@/lib/apis/stream";
import { showError } from "@/lib/toast";

function CustomControlBar({ streamId, stream }: { streamId: number; stream: LiveStreamData }) {
  ...
  return (
    (hostVideoTrack && hostAudioTrack) && room.state !== ConnectionState.Disconnected && (
