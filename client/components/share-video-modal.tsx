...
import { Share, MessageCircle, Facebook, Twitter, Copy, Users, Globe, Lock } from "lucide-react"
...
export function ShareVideoDialog({
    ...
    const handleShareToFeed = async () => {
        ...
        setTimeout(() => {
            toast("Shared to your feed!", {
                description: "Your followers can now see this video",
            })
            setIsSharing(false)
            onOpenChange(false)
            setShareText("")
    ...
    useEffect(() => {
        setShareUrl(`${window.location.href}/shorts/${videoId}`)
    } ,[])
