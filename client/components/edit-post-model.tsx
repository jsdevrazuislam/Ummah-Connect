...
import { deletePostMedia, editPost } from "@/lib/apis/posts";
import { showError } from "@/lib/toast";

type EditPostModelProps = {
  post: PostsEntity;
...
function EditPostModel({
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: ({ postId, payload }: { postId: number; payload: FormData }) => editPost(postId, payload),
