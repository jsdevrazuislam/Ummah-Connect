...
import { AlertTriangle, Clock, LogOut, MapPin, Monitor, Shield, Smartphone, Tablet } from "lucide-react";
                    ...
                    {activeSessions.map(session => (
                      <Card key={session.id}>
                        <CardContent className="p-4">
                          <div className="flex items-start justify-between">
                            <div className="flex items-start gap-3">
                              <div className="text-gray-300">{getDeviceIcon(session.device)}</div>
                              <div className="space-y-1">
                                <p className="font-medium">
                                  {session.browser}
                                  {" "}
