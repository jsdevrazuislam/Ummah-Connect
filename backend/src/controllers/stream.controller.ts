...
export const stream_details = asyncHandler(
    async (req: Request, res: Response) => {
        ...
        return res.json(
            new ApiResponse(200, {stream, token, livekitUrl: process.env.LIVEKIT_URL}, "Stream details fetched successfully")
        );
    }
);

export const get_active_lives = asyncHandler(async (req: Request, res: Response) => {
    ...
    return res.status(200).json(new ApiResponse(200, streams, "Active live streams"));
});
