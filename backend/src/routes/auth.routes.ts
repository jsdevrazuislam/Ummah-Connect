import { change_password, disable_2FA, enable_2FA, get_me, get_user_details, get_user_profile, login_with_2FA, logout, register, update_current_user_info, update_notification_preferences, update_privacy_settings, verify_2FA, verify_email } from '@/controllers/auth.controller'
import { verify_auth } from '@/middleware/auth.middleware'
import { upload } from '@/middleware/multer.middleware'
import { validateData } from '@/middleware/validation.middleware'
import { changePasswordSchema, loginSchema, tokenSchema, userRegistrationSchema } from '@/schemas/auth.schema'
