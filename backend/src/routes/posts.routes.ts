import { bookmarked_post, create_post, delete_post, delete_post_image, edit_post, get_following_posts, get_posts, post_react, share } from '@/controllers/post.controller'
